...
- **Token extraction**: Experimental feature: The script now can extract tokens and IDs from HAR files generated by the browser (Caution: it may not work for all users).
